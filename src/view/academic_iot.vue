  ...
  <v-card-text>
    <div class="my-3">
      <p>
        ...
        Home” พี่ๆจึงอยากให้น้องๆคิดโปรเจคขึ้นมาโปรเจคนึงที่เกี่ยวกับ Smart Home
        โดยโปรเจคนั้นจะต้องสามารถทำได้จริง
    ...
    <v-textarea
      ...
      auto-grow
      rows="3"
      label="โปรเจคที่คิดออกมาใครสามารถนำไปใช้ได้บ้าง"
      clearable
      box
    />
    <v-textarea
